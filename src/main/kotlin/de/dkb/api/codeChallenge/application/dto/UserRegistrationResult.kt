...
sealed class UserRegistrationResult {
    data class Success(val userId: UserId, val subscribedCategories: Set<String>) : UserRegistrationResult()

    data class Failure(val userId: UserId, val errors: List<String>) : UserRegistrationResult()
}
